...
function floatchart () {
  (function () {
    ...
    // Veriyi bir diziye dönüştür (aylara göre sıralanmış)
    ...
    var options6 = {
      ...
      series: [
        {name: 'Mavi Seri', data: [5, 25, 3, 10, 4, 50, 0]}, // Mavi veri serisi
        {name: 'Kırmızı Seri', data: [15, 10, 20, 30, 15, 35, 20]}, // Kırmızı veri serisi
      ],
    };
    var chart = new ApexCharts (
